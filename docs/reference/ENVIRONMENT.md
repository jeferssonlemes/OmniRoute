...
| `CODEX_USER_AGENT`               | `codex-cli/0.144.0 (Windows 10.0.26200; x64)` | When OpenAI updates the Codex CLI                                                                |
| `CODEX_CLIENT_VERSION`           | `0.144.0`                                     | Override Codex client version independently of full UA string                                    |
...
### OpenCode-Go Qwen debug

| Variable                      | Default   | Source File                  | Description                                                                    |
| ----------------------------- | --------- | ---------------------------- | ------------------------------------------------------------------------------ |
| `DEBUG_OPENCODE_GO_QWEN_BODY` | _(unset)_ | `open-sse/executors/base.ts` | Set to `1` to log the upstream request body for qwen3.x 400 diagnosis (#2292). |
